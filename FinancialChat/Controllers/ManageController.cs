    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "Your two-factor authentication provider has been established."
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            // If we get to this point, an error has occurred, we show the form again 
            ModelState.AddModelError("", "The phone could not be verified");
            return View(model);
        }
        ...
        {
            // Request redirection to external login provider to bind a login for current user 
